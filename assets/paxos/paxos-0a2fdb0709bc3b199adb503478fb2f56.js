(function() {
  ...
  d3_transitionPrototype.attrTween = function(nameNS, tween) {
    function attrTween(d, i) {
      ...
      return f === d3_tweenRemove ? (this.removeAttribute(name), null) : f &&
      function(t) {
    ...
    function attrTweenNS(d, i) {
      ...
      return f === d3_tweenRemove ? (this.removeAttributeNS(name.space, name.local), null) : f &&
      function(t) {
  ...
  d3_transitionPrototype.styleTween = function(name, tween, priority) {
    ...
    return this.tween("style." + name, function(d, i) {
      ...
      return f === d3_tweenRemove ? (this.style.removeProperty(name), null) : f &&
      function(t) {
...
(function() {
  Harry.NetworkMember = {
    ...
    broadcastMessage: function(message) {
      return this.network.broadcastMessage(this.id, this.prepareMessage(message));
    },
    prepareMessage: function(message) {
      message.roundNumber = this.roundNumber;
      return message;
    },
    startNewRound: function(roundNumber) {
...
(function() {
  ...
  Harry.Client = (function(superClass) {
    ...
    Client.prototype.propose = function() {
      this.network.nextValue += 1;
      return this.sendMessage(this.replicaIDForMessages(), new Harry.SetValueMessage(this.network.nextValue));
    };
    ...
    Client.prototype.processMessage = function(message) {
      switch (message.constructor) {
        case Harry.QueryResponseMessage:
          return this.queryResponseReceived(message);
      }
    };
    ...
    Client.prototype.queryResponseReceived = function(message) {
      if (this.readAttempt != null) {
        this.readAttempt.count += 1;
        if (this.readAttempt.count === this.network.replicas.length) {
          this.readAttempt.readValue = message.value;
          return true;
        }
      }
    };
...
(function() {
  ...
  Harry.PrepareMessage = (function(superClass) {
    ...
    function PrepareMessage(sequenceNumber, value) {
      ...
      this.value = value;
      PrepareMessage.__super__.constructor.apply(this, arguments);
    }

    PrepareMessage.prototype.type = 1;
  ...
  Harry.PromiseMessage = (function(superClass) {
    ...
    function PromiseMessage(value) {
      this.value = value;
      PromiseMessage.__super__.constructor.apply(this, arguments);
    }

    PromiseMessage.prototype.type = 2;
  ...
  Harry.RejectProposalMessage = (function(superClass) {
    ...
    RejectProposalMessage.prototype.type = 3;

    return RejectProposalMessage;
  ...
  Harry.AcceptMessage = (function(superClass) {
    ...
    function AcceptMessage(sequenceNumber, value) {
      this.sequenceNumber = sequenceNumber;
      this.value = value;
      AcceptMessage.__super__.constructor.apply(this, arguments);
    }

    AcceptMessage.prototype.type = 4;
  ...
  Harry.QueryResponseMessage = (function(superClass) {
    ...
    function QueryResponseMessage(value) {
      this.value = value;
      QueryResponseMessage.__super__.constructor.apply(this, arguments);
    }

    QueryResponseMessage.prototype.type = 7;
  ...
  Harry.SetValueMessage = (function(superClass) {
    ...
    function SetValueMessage(value) {
      this.value = value;
      SetValueMessage.__super__.constructor.apply(this, arguments);
    }

    SetValueMessage.prototype.type = 8;
  ...
  Harry.SetValueResultMessage = (function(superClass) {
    ...
    function SetValueResultMessage(error) {
      this.error = error;
      SetValueResultMessage.__super__.constructor.apply(this, arguments);
    }

    SetValueResultMessage.prototype.type = 9;

    return SetValueResultMessage;
...
(function() {
  ...
  Harry.Replica = (function(superClass) {
    ...
    Replica.transitions({
      startSet: {
        'idle': 'awaiting-promises',
        'awaiting-promises': 'awaiting-promises'
      },
      proposalSucceeded: {
        'awaiting-promises': 'idle'
      },
      proposalFailed: {
        'awaiting-promises': 'idle'
      },
    ...
    Replica.prototype.mixin(Harry.NetworkMember);

    function Replica(id, quorum, network) {
      this.id = id;
      this.quorum = quorum;
      this.network = network;
      Replica.__super__.constructor.call(this, 'idle');
    }

    Replica.prototype.startNewRound = function(roundNumber) {
      this.roundNumber = roundNumber;
      this.set('value', null);
      if (this.timeout != null) {
        clearTimeout(this.timeout);
      }
      this.set('highestSeenSequenceNumber', 0);
      if (this.get('state') !== 'muted') {
        this.set('_state', 'idle');
      }
      return delete this.roundAttempt;
    };

    Replica.prototype.processMessage = function(message) {
      if (message.roundNumber !== this.roundNumber) {
        return;
      }
      switch (message.constructor) {
        case Harry.QueryMessage:
          return this.queryReceived(message);
        case Harry.PrepareMessage:
          return this.prepareReceived(message);
        case Harry.AcceptMessage:
          return this.acceptReceived(message);
        case Harry.SetValueMessage:
          return this.setRequestReceived(message);
        case Harry.PromiseMessage:
          return this.promiseReceived(message);
        case Harry.RejectProposalMessage:
          return this.promiseRejectionReceived(message);
      }
    };
    ...
    Replica.prototype.queryReceived = function(message) {
      return this.sendMessage(message.sender, new Harry.QueryResponseMessage(this.value));
    };

    Replica.prototype.setValue = function(value, callback) {
      if ((this.get('value') != null) && this.get('value') !== value) {
        callback("Can't set a new value if one has already been accepted");
        return false;
      }
      this.set('highestSeenSequenceNumber', this._nextSequenceNumber());
      this.roundAttempt = {
        sequenceNumber: this.get('highestSeenSequenceNumber'),
        callback: callback,
        value: value,
        promisesReceived: 0
      };
      this.startTransition('startSet');
      return this.get('isAwaiting-promises');
    };

    Replica.prototype.promiseReceived = function(message) {
      if (this.roundAttempt != null) {
        if (message.value != null) {
          if (message.value !== this.roundAttempt.value) {
            this.startTransition('proposalFailed');
            return;
          }
        }
        this.roundAttempt.promisesReceived += 1;
        if (this.roundAttempt.promisesReceived >= this.quorum) {
          return this.startTransition('proposalSucceeded');
        }
      }
    };

    Replica.prototype.promiseRejectionReceived = function() {
      return this.startTransition('proposalFailed');
    };
    ...
    Replica.prototype.on('proposalSucceeded', function() {
      var roundAttempt;
      this.broadcastMessage(new Harry.AcceptMessage(this.roundAttempt.sequenceNumber, this.roundAttempt.value));
      this.set('value', this.roundAttempt.value);
      roundAttempt = this.roundAttempt;
      delete this.roundAttempt;
      return typeof roundAttempt.callback === "function" ? roundAttempt.callback() : void 0;
    });

    Replica.prototype.on('proposalFailed', function() {
      var roundAttempt;
      roundAttempt = this.roundAttempt;
      delete this.roundAttempt;
      return roundAttempt != null ? typeof roundAttempt.callback === "function" ? roundAttempt.callback(new Error("value not written")) : void 0 : void 0;
    });

    Replica.prototype.on('proposalSucceeded', 'mute', function() {
      return clearTimeout(this.timeout);
    });

    Replica.prototype.prepareReceived = function(message) {
      var response, shouldStage;
      if (message.sequenceNumber > this.get('highestSeenSequenceNumber')) {
        this.set('highestSeenSequenceNumber', message.sequenceNumber);
        if (this.get('isAwaiting-promises')) {
          this.startTransition('proposalFailed');
        }
        response = new Harry.PromiseMessage(this.get('value'));
        shouldStage = (this.get('value') == null) || this.get('value') === message.value;
      } else {
        response = new Harry.RejectProposalMessage(this.get('highestSeenSequenceNumber'));
        shouldStage = false;
      }
      this.sendMessage(message.sender, response);
      return shouldStage;
    };

    Replica.prototype.acceptReceived = function(message) {
      if (message.sequenceNumber >= this.get('highestSeenSequenceNumber')) {
        if (this.get('isAwaiting-promises')) {
          this.startTransition('proposalFailed');
        }
        this.set('highestSeenSequenceNumber', message.sequenceNumber);
        return this.set('value', message.value);
      }
    };

    Replica.prototype._nextSequenceNumber = function() {
      var base, rounds;
      rounds = Math.floor(this.get('highestSeenSequenceNumber') / this.network.replicaCount);
      base = rounds * this.network.replicaCount;
      return base + this.id;
    };

    Replica.prototype.sendMessage = function() {
      if (this.get('isMuted')) {
        return false;
      }
      return Harry.NetworkMember.sendMessage.apply(this, arguments);
    };
  ...
  Harry.TimePrecedenceReplica = (function(superClass) {
    ...
    TimePrecedenceReplica.prototype.prepareReceived = function(message) {
      var response;
      if (this.get('isAwaiting-promises')) {
        this.startTransition('proposalFailed');
      }
...
(function() {
  ...
  Harry.Network = (function(superClass) {
    ...
    Network.prototype.networkDelayVariability = 2;

    Network.prototype.clientCount = 1;

    Network.prototype.replicaCount = 10;

    Network.prototype.roundNumber = 0;

    Network.prototype.nextValue = 0;
    ...
    Network.prototype.sendMessage = function(originID, destinationID, message) {
      if (this.canSend(originID, destinationID)) {
    ...
    Network.prototype._deliverMessage = function(message) {
      var flightTime;
      flightTime = this.baseNetworkDelay + Math.floor(Math.random() * this.maxAdditionalNetworkDelay);
      this.fire('messageSent', message, flightTime);
      return setTimeout(this._processArrival.bind(this, message), flightTime);
    };

    Network.prototype._processArrival = function(message) {
      return this.entitiesById[message.destination].processMessage(message);
    };
...
(function() {
  ...
  Harry.NetworkVisualizer = (function() {
    ...
    NetworkVisualizer.prototype.labels = false;

    NetworkVisualizer.prototype.nextValue = 0;

    NetworkVisualizer.prototype.proposeEvery = 8500;

    NetworkVisualizer.prototype.newRoundsOnPropose = true;

    NetworkVisualizer.prototype.autoPropose = true;
    ...
    function NetworkVisualizer() {
      ...
      this.easer = d3.ease("cubic-in-out");
      ...
      this.messageLinkLength = (this.valueWidth / 2) + (this.messageWidth / 2) * 1.07;
      this.drawReplicas();
    ...
    NetworkVisualizer.prototype.drawValues = function() {
      ...
      return this.valueCircles.exit().remove();
    };

    NetworkVisualizer.prototype.drawMessages = function() {
      var messages;
      messages = this.svg.selectAll("circle.message").data(this.nodes.filter(function(n) {
        return n instanceof Harry.AbstractMessage;
      })).attr("cx", function(message) {
        return message.x;
    ...
    NetworkVisualizer.prototype.setupInitialValues = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        value.radius = this.valueWidth / 2;
    ...
    NetworkVisualizer.prototype.messageSent = function(message) {
      ...
      if (message.valueLink != null) {
        this.links.splice(this.links.indexOf(message.valueLink), 1);
      }
      shouldStageValue = this.messageReceivedCallbacks[message.id]();
      destination = this.network.entitiesById[message.destination];
      switch (message.constructor) {
        case Harry.SetValueMessage:
        case Harry.PrepareMessage:
          if (shouldStageValue) {
            this.animateStageValue(message, destination);
          }
          break;
        case Harry.QueryResponseMessage:
          if (shouldStageValue) {
    ...
    NetworkVisualizer.prototype.animateSendValue = function(message) {
      var value;
      if (message.value != null) {
        ...
        this.links.push(message.valueLink);
        return this.nodes.push(value);
      }
    };

    NetworkVisualizer.prototype.animateStageValue = function(message, replica) {
      var index, value;
      if (message.valueLink != null) {
        value = message.valueLink.source;
        if (replica.valueLink && ~(index = this.links.indexOf(replica.valueLink))) {
          this.animateReleaseValue(value);
        ...
        return this.links.push(replica.valueLink);
      }
    };

    NetworkVisualizer.prototype.animateAcceptValue = function(replica) {
      return replica.valueLink.holding = false;
    };

    NetworkVisualizer.prototype.animateReleaseValue = function(value) {
      return value.obsolete = true;
    };

    NetworkVisualizer.prototype.animateQueryResponse = function(client) {
      var value;
      ...
      this.links.push(client.valueLink);
      return this.nodes.push(value);
    };
    ...
    NetworkVisualizer.prototype.emitValueChange = function(replica) {
      return this.emitReplicaOrb(replica, 'value-change', "#DE3961");
    };

    NetworkVisualizer.prototype.drawLinks = function() {
      this.link = this.svg.selectAll("line.link").data(this.links.filter(function(link) {
        return link.holding !== false;
      })).attr("x1", function(d) {
        return d.source.x;
      }).attr("y1", function(d) {
        return d.source.y;
      ...
      this.link.enter().append("svg:line").attr("x1", function(d) {
        return d.source.x;
      }).attr("y1", function(d) {
        return d.source.y;
      }).attr("x2", function(d) {
    ...
    NetworkVisualizer.prototype.drawFlyingStuff = function() {
      this.drawMessages();
      this.drawValues();
    ...
    NetworkVisualizer.prototype.setupForceLayout = function() {
      ...
      this.force = d3.layout.force().size([this.width, this.height]).gravity(-0.005).charge(function(d, i) {
        if (d instanceof Harry.Replica) {
          return 0;
        } else {
          return -10;
        }
    ...
    NetworkVisualizer.prototype.collideMessages = function(alpha) {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        destination = this.network.entitiesById[node.destination];
    ...
    NetworkVisualizer.prototype.entityX = function(id) {
      if (id < 0) {
        ...
        return this.replicaXScale(Math.sin(id * this.replicaRadiusStep + Math.PI));
      }
    };
    ...
    NetworkVisualizer.prototype.entityY = function(id) {
      if (id < 0) {
        ...
        return this.replicaYScale(Math.cos(id * this.replicaRadiusStep));
      }
    };
...
(function() {
  ...
  window.mainVisualization = new Harry.NetworkVisualizer({
    ...
    onPropose: function(visualization, network) {
      ...
      return setTimeout(function() {
        return network.clients[1].propose();
      }, 3000);
    }
  });
  ...
  prepareNetwork = function(replicaClass) {
    return new Harry.Network({
      replicaCount: 10,
      clientCount: 2,
      baseNetworkDelay: 1000,
      networkDelayVariability: 0,
  ...
  promiseVisualization = new Harry.NetworkVisualizer({
    ...
    onStart: function(visualization, network) {
      ...
      return firstReplica.promiseReceived = function() {
        this.roundAttempt.promisesReceived += 1;
        if (this.roundAttempt.promisesReceived >= this.quorum) {
          this.startTransition('mute');
          return this.startTransition('unmute');
        }
      };
    }
  });
  ...
  acceptVisualization = new Harry.NetworkVisualizer({
    ...
    onStart: function(visualization, network) {
      ...
      return firstReplica.on('proposalSucceeded', function() {
        clearTimeout(this.timeout);
        this.startTransition('mute');
        return this.startTransition('unmute');
      });
